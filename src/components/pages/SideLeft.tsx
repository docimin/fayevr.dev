...
const SideLeft = () => {
  ...
  return (
    <div className="hidden md:flex flex-col">
      <div className="min-w-rail min-h-rail-cell border-b border-r dark:border-white border-black flex items-center">
        <button
          type="button"
      ...
      <div className="flex flex-col justify-between items-center min-w-[100px] h-full py-3 border-l border-r border-black dark:border-white">
        ...
        >
          ...
          <a href="https://github.com/docimin" target="_blank" rel="noreferrer">
            <SiGithub
              className="dark:text-white"
              style={{
                position: 'absolute',
      ...
      <div className="min-w-[100px] min-h-[75px] border-r border-t dark:border-white border-black flex items-center justify-center">
        <span className="e fingies" id="fg" title="😳">
