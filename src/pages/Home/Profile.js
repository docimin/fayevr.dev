...
const ProfileText = ({ status, titleId }) => (
  <Fragment>
    ...
    <Text
      ...
      size="l"
    >
      I’m Faye, currently I live in Germany working as a Software and Game Developer. My
      projects include Programming, Animations, and creating websites. Being comfortable
    ...
    <Text
      ...
      size="l"
    >
      In my spare time I like to play with my dog, play video games, and{' '}
      <Link href="/projects/vr-assets">do fun projects</Link>. I’m always down for hearing
      or helping new projects, so feel free to drop me a line{' '}
      <Link href="https://discord.com/users/196742608846979072">via Discord</Link>.
    </Text>
  </Fragment>
);
